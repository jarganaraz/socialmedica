...
var listamensajesinsti = window.location.origin +":3800/api/medicmsg/";
var listamensajessoli = window.location.origin +":3800/api/solimsg/";
...
function paginationmio(){
    ...
    document.getElementById('pagination-demo').classList.remove('visualizarfalse')
    document.getElementById('listausuarios1').classList.remove('visualizarfalse')
                ...
                onPageClick(event,page){
                    ...
                    success: function(data){
                       ...
                       data.messagesrta.forEach(element => {
                            ...
                            render(data.messagesrta[i-1],lista,container);
...
function paginationsoli(){
    ...
    document.getElementById('pagination-demo1').classList.remove('visualizarfalse')
    ...
    window.location = 'index.html';
        ...
        $.ajax({
            type: 'GET',
                ...
                url: listamensajessoli,
                dataType: 'json',
            success: function (data) {          
                var totalPages = data.newTotalPages;
                var currentPage = $('#pagination-demo1').twbsPagination('getCurrentPage');
                $('#pagination-demo1').twbsPagination('destroy');
                $('#pagination-demo1').twbsPagination($.extend({}, defaultOpts, {
                    startPage: currentPage,
                    totalPages: data.pages,
                    hideOnlyOnePage : true,
                    first: 'Primera',
                ...
                onPageClick(event,page){
                    ...
                    $.ajax({
                        ...
                        url: listamensajessoli + page,
                        dataType: 'json',
                    success: function(data){
                        count=0;
                       var lista = document.getElementById('contenedor1');
